...
|---|:---:|:---:|:---:|
|[99 Bottles](#99-bottles)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/python/ninety_nine_bottles.py)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/java/ninetyNineBottles.java)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/cpp/NinetyNineBottles.cpp)|
|[Armstrong Number](#Armstrong-Number)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/python/armstrong_number.py)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/java/ArmstrongNumber.java)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/cpp/armstrongNumber.cpp)|
|[Magic 8 Ball](#magic-8-ball)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/python/magic_eight_ball.py)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/java/MagicEightBall.java)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/cpp/magicEightBall.cpp)|
|[GoogleCase](#GoogleCase)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/python/google_case.py)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/java/googleCase.java)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/cpp/googleCase.cpp)|
|[Mad Libs Story Maker](#mad-libs-story-maker)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/python/mad_libs.py)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/java/madLibs.java)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/cpp/madLibs.cpp)|
|[Pythagorean Triples Checker](#pythagorean-triples-checker)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/python/check_pythagorean_triple.py)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/java/checkPythagoreanTriple.java)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/cpp/checkPythagoreanTriple.cpp)|
|[Rock Paper Scissors Game](#rock-paper-scissors-game)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/python/rock_paper_scissors.py)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/java/rockPaperScissors.java)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/cpp/rockPaperScissors.cpp)|
...
|[Base Jumper](#base-jumper)|[:heavy_check_mark:](https://github.com/jclane/beginner-project-solutions/blob/master/python/base_jumper.py)|[:heavy_check_mark:](https://github.com/beginner-project-solutions/blob/master/java/BaseJumper.java)|
